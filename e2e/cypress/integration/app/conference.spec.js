describe('Conference page', () => {
  ...
  it('displays the latest announcement', () => {
    ...
    cy.waitUntil(() =>
      cy
        .findByLabelText('Announcement')
        .should('have.text', 'First announcement'),
    )
  })
  it('can display links in announcement', () => {
    cy.updateAnnouncement(
      'This is an announcement! Make sure to give us <a href="#">feedback</a>.',
    )
    cy.enterConferenceSection()
  ...
  it('updates the announcement in real-time', () => {
    ...
    cy.waitUntil(() =>
      cy
        ...
        .should(
          'have.text',
          'This is an announcement! Make sure to give us feedback.',
        ),
    )
    ...
    cy.waitUntil(() =>
      cy
        .findByLabelText('Announcement')
        .should('have.text', 'Networking party will start at 19:00'),
    )
  })
})
